...
import { Search, MapPin, Clock, Star, Truck, ChefHat, Loader2 } from "lucide-react"
...
export default function RestaurantsPage() {
  ...
  const fetchRestaurants = async () => {
    try {
      ...
      if (selectedCuisine !== "all") filters.category = selectedCuisine
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mb-6">Curated by Admins • Fresh, Fast & Delicious</p>
